...
@endforeach
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="oname" placeholder="Tên chủ..." name="oname" value="{{$bds->dangdum_name}}">
  </div>
  <div class="form-group">
    <label for="onum">SĐT Liên Hệ</label>
    <input type="text" class="form-control" id="onum" placeholder="SĐT..." name="onumber" value="{{$bds->dangdum_phone}}">
  </div>
@else
@endif
