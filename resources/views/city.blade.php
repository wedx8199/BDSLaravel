...
<!-- <form method="get" action="{{route('city',request()->id)}}" enctype="multipart/form-data">
  @csrf
...
<ul class="aside-menu">
              <li><a href="{{route('sortpriceupcity',request()->id)}}"><i class="fa fa-arrow-up"></i>Sắp xếp theo giá tăng dần</a></li>
              <li><a href="{{route('sortpricedowncity',request()->id)}}"><i class="fa fa-arrow-down"></i>Sắp xếp theo giá giảm dần</a></li>
              <li><a href="{{route('sortareaupcity',request()->id)}}"><i class="fa fa-sort-alpha-asc"></i>Diện tích bé đến lớn</a></li>
              <li><a href="{{route('sortareadowncity',request()->id)}}"><i class="fa fa-sort-alpha-desc"></i>Diện tích lớn đến bé</a></li>
              <li><a href="{{route('sortlatestcity',request()->id)}}"><i class="fa fa-clock-o"></i>Tin mới nhất</a></li>
            </ul>
