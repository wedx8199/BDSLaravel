                ...
                <div class="row">
                    ...
                    @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Phone" name="phone" pattern="(\+84|0)\d{9,10}" required>
                                    </div>
                                </div>
                        ...
                        <div class="form-block">
                            ...
                            <div class="text-center">
                                <a class="small" href="{{route('login')}}"><i class="fa fa-key" aria-hidden="true"></i> Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
